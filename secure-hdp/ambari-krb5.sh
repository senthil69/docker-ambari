...
#curl -H "X-Requested-By:ambari" -u admin:admin -i -X PUT -d '{"ServiceInfo": {"state" : "INSTALLED"}}' http://$HOST_FQDN:8080/api/v1/clusters/c1/services/KERBEROS


#curl -H "X-Requested-By:ambari" -u admin:admin -i -X PUT -d '{"ServiceInfo": {"state" : "INSTALLED"}}' http://$HOST_FQDN:8080/api/v1/clusters/c1/services
